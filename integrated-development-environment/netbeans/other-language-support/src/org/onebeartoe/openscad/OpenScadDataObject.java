...
//@GrammarRegistration(grammar="../../tbuser/openscad/tmbundle/Snippets/rotate.tmSnippet", mimeType="text/plain")
...
//@GrammarInjectionRegistration(grammar="cube.tmSnippet", injectTo="source.scad")
//@GrammarRegistration(grammar="use.tmSnippet", mimeType="text/plain")
//@GrammarRegistration(grammar="union.tmSnippet", mimeType="text/plain")
//@GrammarRegistration(grammar="rotate.tmSnippet", mimeType="text/plain")
@Messages(
{
